...
option_list <- list(
    ...
    make_option(c("-t", "--type"), type="character", default=NULL, help="Type of classification: 'C-classification', 'nu-classification', 'one-classification', 'eps-regression', 'nu-regression' (default is to auto-select between C-classification or eps-regression)", metavar="option"), 
    make_option(c("-k", "--kernel"), type="character", default="linear", help="Kernel used to create the support vectors: 'linear', 'polynomial', 'radial', 'sigmoid' (default: %default)", metavar="option"), 
